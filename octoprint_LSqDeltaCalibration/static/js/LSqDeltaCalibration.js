...
Recv: ok
Send: G29.1 P1
Recv: PROBE: X0.0000, Y0.0000, Z0.0050
Recv: PROBE: X-10.4060, Y-4.4403, Z0.0050
Recv: PROBE: X4.7416, Y-15.2813, Z0.0300
Recv: PROBE: X19.3953, Y-2.7970, Z0.0125
Recv: PROBE: X15.6567, Y16.3361, Z0.0025
Recv: PROBE: X-1.8369, Y25.2314, Z0.0150
Recv: PROBE: X-20.4358, Y18.7184, Z0.0175
Recv: PROBE: X-29.9018, Y1.3715, Z0.0275
Recv: PROBE: X-26.3793, Y-18.1144, Z0.0450
Recv: PROBE: X-11.9836, Y-31.7552, Z0.0525
Recv: PROBE: X7.6122, Y-34.9579, Z0.0325
Recv: PROBE: X25.8929, Y-27.1580, Z0.0125
Recv: PROBE: X37.5949, Y-11.0736, Z-0.0550
Recv: PROBE: X39.8532, Y8.7019, Z-0.0725
Recv: PROBE: X32.4465, Y27.1887, Z-0.0400
Recv: PROBE: X17.3777, Y40.2246, Z-0.0625
Recv: PROBE: X-1.9211, Y45.2140, Z-0.0300
Recv: PROBE: X-21.4938, Y41.4007, Z0.0050
Recv: PROBE: X-37.6772, Y29.7393, Z0.0100
Recv: PROBE: X-47.7073, Y12.4905, Z0.0300
Recv: PROBE: X-50.0630, Y-7.3281, Z0.0800
Recv: PROBE: X-44.5526, Y-26.5154, Z0.0900
Recv: PROBE: X-32.1853, Y-42.1913, Z0.0775
Recv: PROBE: X-14.8893, Y-52.1758, Z0.0800
Recv: PROBE: X4.8530, Y-55.2128, Z0.0425
Recv: PROBE: X24.3901, Y-51.0404, Z0.0300
Recv: PROBE: X41.2544, Y-40.3246, Z0.0000
Recv: PROBE: X53.4440, Y-24.4896, Z-0.0425
Recv: PROBE: X59.6152, Y-5.4801, Z-0.0775
Recv: PROBE: X59.1748, Y14.5034, Z-0.1100
Recv: PROBE: X52.2807, Y33.2675, Z-0.0700
Recv: PROBE: X39.7627, Y48.8562, Z-0.0925
Recv: PROBE: X22.9838, Y59.7306, Z-0.0725
Recv: PROBE: X3.6642, Y64.8889, Z-0.0600
Recv: PROBE: X-16.3106, Y63.9216, Z-0.0475
Recv: PROBE: X-35.0764, Y57.0057, Z0.0050
Recv: PROBE: X-50.9580, Y44.8474, Z0.0025
Recv: PROBE: X-62.6020, Y28.5831, Z0.0425
Recv: PROBE: X-69.0710, Y9.6540, Z0.0900
Recv: PROBE: X-69.8942, Y-10.3343, Z0.0725
Recv: PROBE: X-65.0756, Y-29.7518, Z0.0375
Recv: PROBE: X-55.0637, Y-47.0743, Z0.0475
Recv: PROBE: X-40.6905, Y-60.9941, Z0.0575
Recv: PROBE: X-23.0859, Y-70.5056, Z0.1000
Recv: PROBE: X-3.5774, Y-74.9613, Z0.0825
Recv: PROBE: X16.4156, Y-74.0981, Z0.0400
Recv: PROBE: X35.4875, Y-68.0341, Z0.0925
Recv: PROBE: X52.3408, Y-57.2402, Z0.0300
Recv: PROBE: X65.8683, Y-42.4895, Z-0.0125
Recv: PROBE: X75.2157, Y-24.7911, Z-0.0525
Recv: max: 0.1000, min: -0.1100, delta: 0.2100
Recv: ok
*/
