...
$(function() {
    ...
    function probeBed(self) {
        ...
        var radius = self.printerProfilesViewModel.currentProfileData().volume.width();
    ...
    function adjustZScale(zScaleInfo, z, normalSize) {
        ...
        var newScale = normalSize / (zScaleInfo.maxZ - zScaleInfo.minZ);
    ...
    function logProbePoint(self, x, y, z) {
        ...
        self.plot.geometry.attributes.position.setXYZ(self.probePoints.length - 1, x, y, z * 250);
